...
<p class="has-text-align-center has-background-color has-text-color has-link-color has-x-small-font-size"><?php esc_html_e( 'Announcement message can be here.. ', 'kafco' ); ?><a href="#" style="text-decoration:underline"><?php esc_html_e( 'click here', 'kafco' ); ?></a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->