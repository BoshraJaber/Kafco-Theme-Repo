...
<p class="has-text-align-center has-primary-color has-text-color has-x-small-font-size" style="letter-spacing:2px;text-transform:uppercase"><?php esc_html_e( 'Testimonials', 'kafco' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:heading {"textAlign":"center"} -->
<h2 class="wp-block-heading has-text-align-center"><?php esc_html_e( 'See what people have to say about us', 'kafco' ); ?></h2>
<!-- /wp:heading --></div>
<!-- /wp:group -->
...
<p><?php esc_html_e( '★★★★★', 'kafco' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:heading {"level":6,"textColor":"heading","className":"wp-block-heading"} -->
<h6 class="wp-block-heading has-heading-color has-text-color"><?php esc_html_e( 'Highly recommended!', 'kafco' ); ?></h6>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p><?php esc_html_e( 'This theme made the process of building my website a breeze. The drag-and-drop interface was easy to use and the templates were customizable. ', 'kafco' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<p class="has-small-font-size"><?php esc_html_e( 'Darlene Robertson', 'kafco' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"fontSize":"x-small"} -->
<p class="has-x-small-font-size"><?php esc_html_e( 'Web designer', 'kafco' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
...
<!-- wp:heading {"level":6,"textColor":"heading","className":"wp-block-heading"} -->
<h6 class="wp-block-heading has-heading-color has-text-color"><?php esc_html_e( 'Endless customization', 'kafco' ); ?></h6>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p><?php esc_html_e( 'Endless customization options and responsive design, plus great customer support. Highly recommend!', 'kafco' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:group {"style":{"spacing":{"blockGap":"0"}},"layout":{"type":"flex","orientation":"vertical"}} -->
<div class="wp-block-group"><!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size"><?php esc_html_e( 'Ralph Edwards', 'kafco' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"fontSize":"x-small"} -->
<p class="has-x-small-font-size"><?php esc_html_e( 'Marketing Coordinator', 'kafco' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
...
<!-- wp:heading {"level":6,"textColor":"heading","className":"wp-block-heading"} -->
<h6 class="wp-block-heading has-heading-color has-text-color"><?php esc_html_e( 'Superb quality!', 'kafco' ); ?></h6>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p><?php esc_html_e( 'I\'ve tried countless themes, but none have impressed me as much as this! It\'s incredibly fast, which means my website load in a snap.', 'kafco' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:group {"style":{"spacing":{"blockGap":"0"}},"layout":{"type":"flex","orientation":"vertical"}} -->
<div class="wp-block-group"><!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size"><?php esc_html_e( 'Jenny Wilson', 'kafco' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"fontSize":"x-small"} -->
<p class="has-x-small-font-size"><?php esc_html_e( 'Marketer', 'kafco' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
...
<!-- wp:heading {"level":6,"textColor":"heading","className":"wp-block-heading"} -->
<h6 class="wp-block-heading has-heading-color has-text-color"><?php esc_html_e( 'Easy to use', 'kafco' ); ?></h6>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p><?php esc_html_e( 'As a small business owner, I needed a website that was affordable. I was able to create a beautiful website that represented my brand.', 'kafco' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:group {"style":{"spacing":{"blockGap":"0"}},"layout":{"type":"flex","orientation":"vertical"}} -->
<div class="wp-block-group"><!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size"><?php esc_html_e( 'Ronald Richards', 'kafco' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"fontSize":"x-small"} -->
<p class="has-x-small-font-size"><?php esc_html_e( 'Developer', 'kafco' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
...
<!-- wp:heading {"level":6,"textColor":"heading","className":"wp-block-heading"} -->
<h6 class="wp-block-heading has-heading-color has-text-color"><?php esc_html_e( 'Really love it!', 'kafco' ); ?></h6>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p><?php esc_html_e( 'This block-based WordPress theme is a game-changer. I\'ve struggled with complex themes in the past, but this one is easy to use.', 'kafco' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:group {"style":{"spacing":{"blockGap":"0"}},"layout":{"type":"flex","orientation":"vertical"}} -->
<div class="wp-block-group"><!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size"><?php esc_html_e( 'Leslie Alexander', 'kafco' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"fontSize":"x-small"} -->
<p class="has-x-small-font-size"><?php esc_html_e( 'Business owner', 'kafco' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
...
<!-- wp:heading {"level":6,"textColor":"heading","className":"wp-block-heading"} -->
<h6 class="wp-block-heading has-heading-color has-text-color"><?php esc_html_e( 'Great on any device', 'kafco' ); ?></h6>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p><?php esc_html_e( 'I\'ve used a few different website builders over the years, and this one is by far the best. The responsive design ensures that my website looks great on any device.', 'kafco' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:group {"style":{"spacing":{"blockGap":"0"}},"layout":{"type":"flex","orientation":"vertical"}} -->
<div class="wp-block-group"><!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size"><?php esc_html_e( 'Jacob Jones', 'kafco' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"fontSize":"x-small"} -->
<p class="has-x-small-font-size"><?php esc_html_e( 'Freelancer', 'kafco' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
