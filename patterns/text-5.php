...
<p class="has-primary-color has-text-color has-x-small-font-size" style="letter-spacing:2px;text-transform:uppercase"><?php esc_html_e( 'Full Site Editing', 'kafco' ); ?></p>
<!-- /wp:paragraph -->
...
<h2 class="wp-block-heading"><?php esc_html_e( 'Unleash the power of block editor', 'kafco' ); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p><?php esc_html_e( 'Customize the entire website layout, including the header, footer, and all other template parts. With FSE, we can create and edit templates for their entire website, including single posts, archive pages, and custom post types.', 'kafco' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<h6 class="wp-block-heading"><?php esc_html_e( 'Download Spectra Theme', 'kafco' ); ?></h6>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"var:preset|spacing|xx-small"}}},"textColor":"body","fontSize":"x-small"} -->
<p class="has-body-color has-text-color has-x-small-font-size" style="margin-top:var(--wp--preset--spacing--xx-small)"><?php esc_html_e( 'Version 1.0.0', 'kafco' ); ?></p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph -->
<p><?php esc_html_e( 'Interactive design tools and its many customization options to customize anything and everything needed to build the fully-functional website of your dreams.', 'kafco' ); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button has-custom-width wp-block-button__width-100"><a class="wp-block-button__link wp-element-button" href="#"><?php esc_html_e( 'Download Now', 'kafco' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
