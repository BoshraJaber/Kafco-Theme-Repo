...
registerBlockType("ourblocktheme/ourvalues", {
    title: "Our Value",
    ...
    attributes: {
        ...
        imgID: { type: "number" },
        imgURL: { type: "string", default: ourvalues.fallbackimage }
    },
    edit: EditComponent,
    save: SaveComponent
})
    ...
    return (
        <>
            ...
            <div className="page-banner bg-white">
                ...
                <div className="">
                    <InnerBlocks allowedBlocks={["ourblocktheme/genericheading", "ourblocktheme/genericbutton", "ourblocktheme/ourvaluescards"]} />
                </div>
